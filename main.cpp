...
int main() {
    ...
    book.submit(Order(1, 'B', 50.0, 100));
    ...
    book.submit(Order(2, 'S', 60.0, 101));
    ...
    book.submit(Order(3, 'S', 50.0, 102));
    ...
    book.submit(Order(4, 'S', 70.0, 103));
    book.cancel(4);
    ...
    book.submit(Order(5, 'B', 40.0, 104));
    book.submit(Order(6, 'B', 45.0, 105));
    ...
    book.submit(Order(7, 'S', 80.0, 106));
    book.submit(Order(8, 'S', 75.0, 107));
    ...
    book.submit(Order(9, 'B', 78.0, 108));
    ...
    book.submit(Order(10, 'S', 40.0, 109));
